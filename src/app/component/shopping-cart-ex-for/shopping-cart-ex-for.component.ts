...
@Component({
  selector: 'app-shopping-cart-ex-for',
  templateUrl: './shopping-cart-ex-for.component.html',
  styleUrl: './shopping-cart-ex-for.component.css'
})
export class ShoppingCartExForComponent {
